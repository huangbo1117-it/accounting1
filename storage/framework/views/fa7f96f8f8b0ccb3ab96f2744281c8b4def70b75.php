<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(asset('js/nicEdit.js')); ?>"></script>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="TemplateName" value="<?php echo e($template->Name); ?>" id="TemplateName" required>
                </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control" id="dbParameters">
                        <?php $__currentLoopData = $parms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($ss->Name); ?>"><?php echo e($ss->Name); ?></option>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <textarea id="test" hidden><?php echo e($template->Detail); ?></textarea>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/jquery.wordexport.js')); ?>"></script>
    <script>
