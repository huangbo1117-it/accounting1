<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <?php if(count($user) > 0 || Request::input('searchUser') != ""): ?>
                ...
                <div class="col-md-12 pull-right">
                    <form name="form" method="get">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="searchUser" value="<?php echo e(Request::input('searchUser')); ?>" placeholder="Search User By ID " >
                            </div>
                            <div class="col-md-1">
        ...
        <?php if(count($user) > 0): ?>
            ...
            <table class="table table-striped task-table">
                ...
                <tbody>
                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="table-text" >
                            <div><?php echo e($cd->email); ?></div>
                        </td>
                        <td class="table-text" >
                            <div><?php echo e($cd->groupName); ?></div>
                        </td>
                        <td class="pull-right">
                            <?php if($cd->groupName == 'client'): ?>
                                <button class="btn btn-primary" onclick="getUserCreditor('<?php echo e($cd->id); ?>','<?php echo e($cd->email); ?>')">Creditors</button>
                            <?php endif; ?>
                            <form action="/editUser/<?php echo e($cd->id); ?>" class="inline">
                                <button type="submit" name="edit" class="btn btn-primary">Edit</button>
                                <?php echo e(csrf_field()); ?>

                            </form>

                            <a href="<?php echo e(url('deleteUser',$cd->id)); ?>" class="btn btn-danger"
                               data-tr="tr_<?php echo e($cd->id); ?>"
