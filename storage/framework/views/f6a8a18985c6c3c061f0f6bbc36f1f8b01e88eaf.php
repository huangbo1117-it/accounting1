<?php $__env->startSection('content'); ?>
    <div class="container">
        <h1>Add Invoice</h1>
        <?php if($trustActivity->BilledFor == 1): ?>
        ...
        <form name="form" method="post">
            ...
            <input type="hidden" class="form-control" name="DebtorID"  id="DebtorID"  value="<?php echo e($trustActivity->DebtorID); ?>">
            <input type="hidden" class="form-control" name="IPaymentType"  id="IPaymentType"  value="<?php echo e($trustActivity->TPaymentType); ?>">
            <br>
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control txtboxToFilter" name="TotalBill"  id="TotalBill"  value="<?php echo e($trustActivity->PaymentReceived); ?>"  required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control txtboxToFilter" name="Fee1Balance" id="Fee1Balance" value="<?php echo e($trustActivity->PaymentReceived); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
