            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ContactID2" value="<?php echo e($ContactID); ?>" disabled>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="salesman" required>
                            <?php $__currentLoopData = $sm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->SalesID); ?>"><?php echo e($s->SFirstName); ?> <?php echo e($s->SLastName); ?></option>
