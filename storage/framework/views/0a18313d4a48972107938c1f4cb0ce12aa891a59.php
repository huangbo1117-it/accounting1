        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <ul class="list-group">
                    ...
                    <?php $__currentLoopData = $Role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="list-group-item" style="cursor: pointer;" ng-click="loadRight(<?php echo e($ss); ?>)"><?php echo e($ss->name); ?></li>
