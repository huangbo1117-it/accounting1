<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <h1>Add New Debtor  <?php if($DID != null): ?><a href="/Letters/<?php echo e($DID); ?>" target="_blank" class=" btn btn-info">Print Letters For Last Debtor</a><?php endif; ?></h1>
            ...
            <div class="row" >
                <div class="col-md-2" >
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="debtorID" value="<?php echo e($DebtorID); ?>" >
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="statusID" required>
                            <?php $__currentLoopData = $sm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->StatusID); ?>"><?php echo e($s->StatusDesc); ?> </option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="creditorID2" id="creditorID2" required onchange="getContactName(this)">
                            ...
                            <?php $__currentLoopData = $cd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->CreditorID); ?>"><?php echo e($s->CreditorID); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="creditorID" id="creditorID" required onchange="getContactName(this)">
                            ...
                            <?php $__currentLoopData = $cd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->CreditorID); ?>"><?php echo e($s->ClientName); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
