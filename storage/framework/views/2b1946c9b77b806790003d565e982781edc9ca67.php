<?php $__env->startSection('content'); ?>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <?php if($first != null): ?>
                  <span style="margin: 5px;"><a href="/EditCreditor/<?php echo e($first); ?>" class="btn btn-info align " role="button">First</a></span>
        <?php endif; ?>
        <?php if($previous != null): ?>
            <span style="margin: 5px;"><a href="/EditCreditor/<?php echo e($previous); ?>" class="btn btn-info align " role="button">Previous</a></span>
        <?php endif; ?>
            <?php if($Next != null): ?>
               <span style="margin: 5px;">     <a href="/EditCreditor/<?php echo e($Next); ?>" class="btn btn-info align " role="button">Next</a></span>
            <?php endif; ?>
        <?php if($last != null): ?>
            <span style="margin: 5px;">     <a href="/EditCreditor/<?php echo e($last); ?>" class="btn btn-info align " role="button">Last</a></span>
        <?php endif; ?>
...
<div id="viewDetail">
            <input type="hidden" value="<?php echo e($creditor->CreditorID); ?>" id="updateCreditorID" name="updateCreditorID">
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="creditorID">Creditor ID:</label>
                        <input type="text" class="form-control" name="creditorID" value="<?php echo e($creditor->CreditorID); ?>" id="creditorID" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="opendate" value="<?php echo e($creditor->OpenDate); ?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="lastdate">Last Date:</label>
                        <input type="date" class="form-control" name="lastdate" value="<?php echo e($creditor->LastDate); ?>" required>
                    </div>
                </div>
                <input type="checkbox" name="compreport" value="1" <?php if($creditor->CompReport== true): ?> checked <?php endif; ?>> Comp Report
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="country" value="<?php echo e($contact->Country); ?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <span hidden><input type="text" class="form-control" name="ContactID" value="<?php echo e($contact->ContactID); ?>" ></span>
                        <input type="text" class="form-control" name="ContactID2" value="<?php echo e($contact->ContactID); ?>" disabled>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control txtboxToFilter" id="Maskphone" name="phone" value="<?php echo e($contact->Phone); ?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="ext">Ext:</label>
                        <input type="text" class="form-control txtboxToFilter" id="MaskExt" name="ext" value="<?php echo e($contact->Ext); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="fax">Fax:</label>
                        <input type="text" class="form-control txtboxToFilter" id="MaskFax" name="fax" value="<?php echo e($contact->Fax); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="Email">Email:</label>
                        <input type="email" class="form-control" name="Email" required value="<?php echo e($creditor->Email); ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="salesman" required>
                            <?php $__currentLoopData = $sm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->SalesID); ?>" <?php if($s->SalesID == $creditor->SaleID): ?> selected <?php endif; ?> ><?php echo e($s->SFirstName); ?> <?php echo e($s->SLastName); ?></option>
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="comments"><?php echo e($creditor->Comments); ?> </textarea>
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="Placed" value="<?php echo e($NumbOfDebt); ?>" disabled/>
            </div></div>
                    <div class="col-md-2">
            <div class="form-group">
                <label for="compreport">Total $ Placed:</label>
                ...
                <input class="form-control" name="PlacedT" value="<?php echo e($SumOfAmountPlaced); ?>" disabled/>
                    </div>
            </div></div>
                        <div class="col-md-2">
            <div class="form-group">
                ...
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                <input class="form-control" name="Collected" disabled value="<?php echo e($totalCollectedValue); ?>"/>
                    </div>
            </div></div>
                            <div class="col-md-2">
            <div class="form-group">
                ...
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <input class="form-control" name="Pending"value="<?php echo e(floatval($SumOfAmountPlaced)-floatval($totalCollectedValue)); ?>" disabled/>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="Invoice" value="<?php echo e($InvDues); ?>" disabled/>
            </div></div>
                                    <div class="col-md-2">
            <div class="form-group">
                <label for="compreport">Total Trust:</label>
                <input class="form-control" name="Trust" value="<?php echo e($txtTotalRec); ?>" disabled />
            </div>
                                    </div>
                <div class="col-md-3">
                    <div class="form-group">
