...
@section('content')
    <div class="container">
        ...
        <form name="form" method="post">
            {{ csrf_field() }}
            <input type="hidden" class="form-control" name="updateTPaymentID" value="{{$trustActivity->TPaymentID}}" >
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="colID" required>
                            @foreach($col as $s)
                                <option value="{{$s->ColID}}" @if($s->ColID == $trustActivity->ColID) selected @endif>{{$s->CLastName}}  {{$s->CFirstName}}</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="checkNo" value="{{$trustActivity->CheckNumb}}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="creditorID">Payment Received:</label>
                        <input type="text" class="form-control" id="paymentReceived" onchange="calculate()" name="paymentReceived" value="{{$trustActivity->PaymentReceived}}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="creditorID">Release Date:</label>
                        <!--<input type="date" class="form-control" name="releaseDate" value="{{$trustActivity->RelDate}}" required>-->
                        <input type="text" name="releaseDate" class="form-control" value="{{$trustActivity->RelDate}}" id="date"  size="12" />
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="creditorID">Intrest:</label>
                        <input type="text" class="form-control" name="Intrest" onchange="calculate()" value="{{$trustActivity->Intrest}}" required>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="creditorID">Attorney Fee:</label>
                        <input type="text" class="form-control" name="AttorneyFee" onchange="calculate()" value="{{$trustActivity->AttyFees}}" required>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="MiscFee" onchange="calculate()" value="{{$trustActivity->MiscFees}}" required>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="CostRef" onchange="calculate()" value="{{$trustActivity->CostRef}}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="creditorID">Agency Gross: </label>
                        <input type="text" class="form-control" id="AgencyGross" onchange="calculate()" name="AgencyGross" value="{{$trustActivity->AgencyGross}}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
